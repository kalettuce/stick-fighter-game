...
class Level5 extends FlxState {
    ...
    override public function create() {
        ...
        if (FlxG.save.data.version == "A") {
            mapPath = "assets/levels/level5A_terrain.csv";
        } else {
            mapPath = "assets/levels/level5B_terrain.csv";
            doors = new FlxTilemap();
            doors.loadMapFromCSV("assets/doors/level5B_doors.csv", "assets/images/sf_level_tiles.png", 64, 64);
            add(doors);
        }
        map = new FlxTilemap();

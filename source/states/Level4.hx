...
class Level4 extends FlxState {
    ...
    override public function create() {
        ...
        if (FlxG.save.data.version == "A") {
            mapPath = "assets/levels/level4A_terrain.csv";
        } else {
            mapPath = "assets/levels/level4B_terrain.csv";
            doors = new FlxTilemap();
            doors.loadMapFromCSV("assets/doors/level4B_doors.csv", "assets/images/sf_level_tiles.png", 64, 64);
            add(doors);
        }
        map = new FlxTilemap();
        ...
        // create minions
        final xPosArr:Array<Int> = [1700, 1800, 1900, 300, 400, 500, 100, 300, 500, 1150, 1250, 1350, 1050, 1150, 1250, 1800, 2000];
    ...
    override public function update(elapsed:Float) {
        ...
        if (enemy.isDead() && enemy2.isDead() && FlxG.save.data.version == "B" && !doorsRemoved) {
            remove(doors);
            doorsRemoved = true;
        }

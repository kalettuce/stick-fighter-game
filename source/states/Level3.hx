...
class Level3 extends FlxState {
    ...
    override public function create() {
        ...
        if (FlxG.save.data.version == "A") {
            mapPath = "assets/levels/level3A_terrain.csv";
        } else {
            mapPath = "assets/levels/level3B_terrain.csv";
            doors = new FlxTilemap();
            doors.loadMapFromCSV("assets/levels/level3B_doors.csv", "assets/images/sf_level_tiles.png", 64, 64);
            add(doors);
        }
        map = new FlxTilemap();
        ...
        // levelScreen.loadGraphic("assets/images/Level3.png");
    ...
    override public function update(elapsed:Float) {
        ...
        if (enemy.isDead() && enemy.animation.finished &&
            ...
            FlxG.save.data.unlockedFour = true;
            FlxG.save.flush();

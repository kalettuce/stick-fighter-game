...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("stickfighter", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("stickfighter", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "stickfighter";
		app.meta["name"] = "stickfighter";
